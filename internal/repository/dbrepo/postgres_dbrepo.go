...
func (m *PostgresDBRepo) AllMovies() ([]*models.Movie, error) {
	...
	//declare a slice of hold the models.Movie objects
...
// สร้างฟังก์ชันอ่านรายการหนังตาม ID สำหรับแก้ไข
...
func (m *PostgresDBRepo) UpdateMovie(movie models.Movie) error {
	...
	stmt := `
	update 
		movies set title = $1, description = $2, release_date = $3,
